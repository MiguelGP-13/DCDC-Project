...
El tópico 3 constituye el caso más relevante desde el punto de vista de exogeneidad. En este tópico se identifican dependencias estadísticamente significativas con los sectores de Sanitario y Salud, Construcción e Inmobiliaria y Administración y Finanzas, todos ellos con coeficientes positivos. Este resultado sugiere que incrementos en la actividad de estos sectores se asocian con aumentos en el valor del tópico, evidenciando una relación temporal consistente y reforzando la interpretación de que su evolución no depende exclusivamente de su dinámica autorregresiva. Esto sugiere que el tópico 3 no responde únicamente a su dinámica autorregresiva, y está condicionado por la evolución de sectores con periodos de mayor actividad laboral.
